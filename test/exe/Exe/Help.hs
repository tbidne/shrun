...
expected =
  [ "Shrun: A tool for running shell commands concurrently.",
    "",
    "Usage: shrun [Available options] [Common Logging options]",
    "             [Command Logging options] [Console Logging options]",
    "             [File Logging options] [Notifications options] [Other commands] ",
    "             [Commands...]",
    "",
    ...
    "         Max text length held by the log buffer, used with",
    "         '--command-log-read-strategy block-line-buffer'. Defaults to 1,000",
    "         characters.",
    "",
    "  --command-log-buffer-timeout (NATURAL | TIME_STR)",
    "         Max time the log buffer will hold a log before flushing it, used with",
    "         '--command-log-read-strategy block-line-buffer'. Defaults to 30",
    "         seconds.",
    "",
    "  --command-log-poll-interval NATURAL",
    "         Non-negative integer used with --console-log-command and --file-log",
    ...
    "         Defaults to 10,000. Note that lower values will increase CPU usage. In",
    ...
    "         the default) except when all of the following are true: file-log: on,",
    "         file-log-multi: off, and concurrent commands. There is therefore no",
    "         need to set this option, except to set 'block' unconditionally.",
    "          ",
    ...
    "",
    "  --file-log-multi (on | auto | off)",
    "         Logs each command to its own file, rather than all logs being sent to",
    "         the same file. In particular, this allows usage with",
    "         '--command-log-read-strategy block-line-buffer' and concurrent",
    "         commands. The filename is based on --file-log. Note that",
    "         --file-log-mode applies to the generated file. With 'auto', activates",
    "         if and only if there are concurrent commands.",
    "",
    ...
    "",
    "  --notify-error-urgency (low | normal | critical)",
    "         Urgency level for error notifications. Defaults to critical.",
    "",
    ...
    "         exits. Requires a command.",
    "",
    "  --expand-aliases",
    "         Prints all expanded aliases from the config.",
    "",
    "Shrun: <vers> (<hash>)"
  ]
