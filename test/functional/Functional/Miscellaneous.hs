  ...
  where
    ...
    expected =
      [ "{",
        ...
        "    {",
        "      \"key\": \"backend\",",
        "      \"val\": \"echo \\\"building backend...\\\"; sleep 7\"",
        "    },",
        "    {",
        "      \"key\": \"build\",",
        "      \"val\": \"frontend, backend, db\"",
        "    },",
        "    {",
        "      \"key\": \"c\",",
        "      \"val\": \"b\"",
        ...
        "    {",
        "      \"key\": \"db\",",
        "      \"val\": \"echo \\\"building database...\\\"; sleep 4; echo \\\"database failed\\\"; sleep 1; exit 1\"",
        "    },",
        "    {",
        "      \"key\": \"deploy\",",
        "      \"val\": \"build, ds\",",
        ...
        "    {",
        "      \"key\": \"ds\",",
        "      \"val\": \"echo \\\"deploying app...\\\"; sleep 2\"",
        "    },",
        "    {",
        "      \"key\": \"frontend\",",
        "      \"val\": \"echo \\\"building frontend...\\\"; sleep 2\"",
        "    },",
        "    {",
        "      \"key\": \"some-key\",",
        "      \"val\": \"echo hi && sleep 2\"",
        ...
        "    {",
        "      \"key\": \"stats\",",
        "      \"val\": \"echo \\\"running stats...\\\"; sleep 3\"",
        "    }",
        "  ],",
        "  \"locals\": []",
        "}"
